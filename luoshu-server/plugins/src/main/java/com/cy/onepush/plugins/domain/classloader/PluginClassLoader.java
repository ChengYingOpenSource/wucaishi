...
public class PluginClassLoader extends URLClassLoader {
    ...
    public synchronized Class<?> loadClassLocal(String name) throws ClassNotFoundException {
        return loadClassLocal(name, false);
    }

    protected synchronized Class<?> loadClassLocal(String name, boolean resolve)
        throws ClassNotFoundException {
        // First, check if the class has already been loaded
        Class<?> c = findLoadedClass(name);
        if (c == null) {
