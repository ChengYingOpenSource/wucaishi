...
public final class ServiceLoader<S>
    ...
    private ServiceLoader(Class<S> svc, ClassLoader cl, ServiceCreator sc) {
        service = Objects.requireNonNull(svc, "Service interface cannot be null");
        loader = (cl == null) ? ClassLoader.getSystemClassLoader() : cl;
        serviceCreator = (sc == null) ? (klass, classLoader) -> klass.newInstance() : sc;
    ...
    private class LazyIterator
        ...
        private S nextService() {
            ...
            try {
                S p = service.cast(serviceCreator.create(c, loader));
                providers.put(cn, p);
                return p;
            } catch (Throwable x) {
                fail(service,
    ...
    // Private inner class implementing fully-lazy provider class lookup
    //
    private class LazyKclassIterator
        ...
        private LazyKclassIterator(Class<S> service, ClassLoader loader) {
            this.service = service;
            this.loader = loader;
        }
        ...
        private Class<S> nextService() {
            ...
            Class<S> c = null;
            try {
                c = (Class<S>) Class.forName(cn, false, loader);
            } catch (ClassNotFoundException x) {
                fail(service,
                    "Provider " + cn + " not found");
            }
    ...
    public Iterator<Class<S>> iteratorKlass() {
        return new LazyKclassIterator(service, loader);
    }
     ...
     *                       used
     * @param serviceCreator the creator for create the service
     * @return A new service loader
     */
    public static <S> ServiceLoader<S> load(Class<S> service,
                                            ClassLoader loader,
                                            ServiceCreator serviceCreator) {
        return new ServiceLoader<>(service, loader, serviceCreator);
    }
    ...
    public static <S> ServiceLoader<S> load(Class<S> service) {
        ...
        return ServiceLoader.load(service, cl, null);
    }
    ...
    public static <S> ServiceLoader<S> loadInstalled(Class<S> service) {
        ...
        return ServiceLoader.load(service, prev, null);
    }
    ...
    public interface ServiceCreator {
        ...
        Object create(Class<?> klass, ClassLoader classLoader) throws Exception;
